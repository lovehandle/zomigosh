  ...
  $.fn.tweet = function(o){
    ...
    function extract_template_data(item){
      ...
      o.avatar = o.avatar_size ?
        t('<img src="{avatar_url}" height="{avatar_size}" width="{avatar_size}" alt="{screen_name}\'s avatar" title="{screen_name}\'s avatar" border="0" style="float:left; padding:0 10px 10px 0;"/>', o) : '';
